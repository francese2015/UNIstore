 ...
 */
public class ParseLoginFragment extends ui.ParseLoginFragmentBase {
    ...
    private ui.ParseOnLoginSuccessListener onLoginSuccessListener;

    private ui.ParseLoginConfig config;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent,
        ...
        config = ui.ParseLoginConfig.fromBundle(getArguments(), getActivity());
    ...
    public void onAttach(Activity activity) {
        ...
        if (activity instanceof ui.ParseOnLoginSuccessListener) {
            onLoginSuccessListener = (ui.ParseOnLoginSuccessListener) activity;
        } else {
            throw new IllegalArgumentException(
                    "Activity must implemement ParseOnLoginSuccessListener");
        }

        if (activity instanceof ui.ParseOnLoadingListener) {
            onLoadingListener = (ui.ParseOnLoadingListener) activity;
        } else {
            throw new IllegalArgumentException(
