 ...
 * {@link ui.ParseLoginConfig} for available settings.</li>
 ...
 * <li>Using {@link ui.ParseLoginBuilder} to construct an intent that can be used
 * to start this activity with your customizations.</li>
 * </ul>
 */
public class ParseLoginActivity extends FragmentActivity implements
        ui.ParseLoginFragment.ParseLoginFragmentListener,
        ui.ParseLoginHelpFragment.ParseOnLoginHelpSuccessListener,
        ui.ParseOnLoginSuccessListener, ui.ParseOnLoadingListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction().add(fragmentContainer,
                    ui.ParseLoginFragment.newInstance(configOptions)).commit();
        }
    }
    ...
    public void onSignUpClicked(String username, String password) {
        ...
        transaction.replace(fragmentContainer,
                ui.ParseSignupFragment.newInstance(configOptions, username, password));
    ...
    public void onLoginHelpClicked() {
        ...
        FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
        transaction.replace(fragmentContainer, ui.ParseLoginHelpFragment.newInstance(configOptions));
        transaction.addToBackStack(null);
        transaction.commit();
    }
