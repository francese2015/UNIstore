 ...
 */
public class AnnuncioExpandedCard extends CardExpand {

    int count;

    public AnnuncioExpandedCard(Context context) {
        super(context, R.layout.card_view_inner_content_expand);
    }

    public AnnuncioExpandedCard(Context context, int i) {
        super(context, R.layout.card_view_inner_content_expand);
        count = i;
    }
